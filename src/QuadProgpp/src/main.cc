...
int main (int argc, char *const argv[]) {
  ...
  x.resize(n);
	...
	// std::cout << G.nrows() << G.ncols() << std::endl;
	// std::cout << g0.size() << std::endl;
	// std::cout << CE.nrows() << CE.ncols() << std::endl;
	// std::cout << ce0.size() << std::endl;
	// std::cout << CI.nrows() << CI.ncols()<< std::endl;
	// std::cout << ci0.size() << std::endl;
